...
curl -X GET //organizations/{org_db}/appointments/{status}?date_from=string&date_to=string \
  -H 'Accept: application/json'

```

```http
GET //organizations/{org_db}/appointments/{status}?date_from=string&date_to=string HTTP/1.1
Host: null
...
$.ajax({
  url: '//organizations/{org_db}/appointments/{status}',
  method: 'get',
...
fetch('//organizations/{org_db}/appointments/{status}?date_from=string&date_to=string',
{
  method: 'GET',
...
result = RestClient.get '//organizations/{org_db}/appointments/{status}',
  params: {
  'date_from' => 'string',
'date_to' => 'string'
}, headers: headers
...
r = requests.get('//organizations/{org_db}/appointments/{status}', params={
...
```java
URL obj = new URL("//organizations/{org_db}/appointments/{status}?date_from=string&date_to=string");
...
`GET /organizations/{org_db}/appointments/{status}`

Appointments of particular status for organization.
...
status|path|string|true|Appointment status code: confirmed, available, pending, noshow
...
[
  {
    "status": "step_1",
    "time_start": "2018-01-26T23:27:51Z",
    "time_end": "2018-01-26T23:27:51Z",
    "sms_reminder": "2018-01-26T23:27:51Z",
    "note": "string",
    "id_client": "string",
    "id_service": "string",
    "staff": [
    ...
    "recurring_exception_date": "2018-01-26T23:27:51Z",
    "recurring_dates": [
      "2018-01-26T23:27:51Z"
    ],
    "booking_info": {
      "client_name": "string",
    ...
    "_rev": "string",
    "type": "user_t3",
    "time_create": "2018-01-26T23:27:51Z",
    "time_update": "2018-01-26T23:27:51Z",
    "time_delete": "2018-01-26T23:27:51Z",
    "user_create": "string",
    "user_update": "string",
    "user_delete": "string",
    "db_origin": "string"
...
```json
{
  ...
  "org_db": "string",
  "is_available": true,
  "time_reserved": "2018-01-26T23:27:51Z",
  "time_released": "2018-01-26T23:27:51Z"
}
```
```json
{
...
```shell
# You can also use wget
curl -X DELETE //domains/{name}?org_db=string&org_id=string \
  -H 'token: string' \
  -H 'Accept: application/json'
...
```http
DELETE //domains/{name}?org_db=string&org_id=string HTTP/1.1
Host: null
...
## RegisterApiDeleteUser

> Code samples

```shell
# You can also use wget
curl -X GET //delete_user?username=string&user_id=string \
  -H 'token: string' \
  -H 'Accept: application/json'
...
```http
GET //delete_user?username=string&user_id=string HTTP/1.1
Host: null
...
$.ajax({
  url: '//delete_user',
  method: 'get',
  data: '?username=string&user_id=string',
  headers: headers,
  success: function(data) {
    console.log(JSON.stringify(data));
  }
...
fetch('//delete_user?username=string&user_id=string',
{
  method: 'GET',
...
result = RestClient.get '//delete_user',
  params: {
  'username' => 'string',
'user_id' => 'string'
}, headers: headers
...
r = requests.get('//delete_user', params={
...
```java
URL obj = new URL("//delete_user?username=string&user_id=string");
HttpURLConnection con = (HttpURLConnection) obj.openConnection();
con.setRequestMethod("GET");
int responseCode = con.getResponseCode();
BufferedReader in = new BufferedReader(
...
Delete user completely from termin3 system

<h3 id="RegisterApiDeleteUser-parameters">Parameters</h3>

Parameter|In|Type|Required|Description
---|---|---|---|---|
token|header|string|true|
username|query|string|true|Username (same as email)
user_id|query|string|true|User document ID
...
```
<h3 id="RegisterApiDeleteUser-responses">Responses</h3>
...
<h3 id="RegisterApiDeleteUser-responseschema">Response Schema</h3>
...
```json
{
  ...
  "stats": {
    ...
    "doc_created_min": {
      "CommonDbModelDocumentType": "2018-01-26T23:27:51Z",
      "global": "2018-01-26T23:27:51Z"
    },
    "doc_created_max": {
      "CommonDbModelDocumentType": "2018-01-26T23:27:51Z",
      "global": "2018-01-26T23:27:51Z"
    ...
    "last_run": "2018-01-26T23:27:51Z",
    "termin3_code": "string",
    "termin3_version": "string",
    "termin_last_date": "2018-01-26T23:27:51Z",
    "termins_in_future": 0
  },
  "domain_info": {
    "domain_name": "string",
...
```json
{
  "date_expiration": "2018-01-26T23:27:51Z",
  "date_start": "2018-01-26T23:27:51Z",
  "activated": true,
  "db_org": "string",
...
```json
{
  ...
  "start_date": "2018-01-26T23:27:51Z",
  "end_date": "2018-01-26T23:27:51Z",
  "freq": "once",
  "until_type": "counter",
  "until_counter": 0,
  "custom_days": 0,
  "custom_weeks": 0,
  "custom_months": 0,
  "cached_until": "2018-01-26T23:27:51Z",
  "_id": "string",
  "_rev": "string",
  "type": "user_t3",
  "time_create": "2018-01-26T23:27:51Z",
...
```json
{
  ...
  "id_termin": "string",
  "id_recurring_meta": "string",
  "id_recurring_date": "2018-01-26T23:27:51Z",
  "recurring_termin_next_date": "2018-01-26T23:27:51Z",
  "recipient_type": "client",
  "id_client": "string",
  "id_staff": "string",
  "scheduled_time": "2018-01-26T23:27:51Z",
  "id_device": "string",
  "recipient_phone": "string",
  "id_message_template": "string",
  "message": "string",
  "snap_termin_time": "2018-01-26T23:27:51Z",
  "snap_termin_end_time": "2018-01-26T23:27:51Z",
...
```json
{
  ...
  "info": {
    ...
    "last_active_time": "2018-01-26T23:27:51Z",
    "termins_created": 0,
    "services_created": 0,
    "reminders_created": 0,
    "recurring_created": 0,
    "clients_created": 0,
    "review_asked_time": "2018-01-26T23:27:51Z",
    "review_clicked": true,
...
```json
{
  ...
  "email_primary_sent_time": "2018-01-26T23:27:51Z",
  "_id": "string",
  "_rev": "string",
  "type": "user_t3",
  "time_create": "2018-01-26T23:27:51Z",
...
## OrgTermin3DomainDbModel

<a name="schemaorgtermin3domaindbmodel"></a>
...
» termin_last_date|string(date-time)|false|Date when starts the last appointment in organization database
» termins_in_future|number(double)|false|Number of appointments scheduled in future
domain_info|object|true|Domain info
» domain_name|string|false|Domain name
» org_db|string|false|Organization database name
» is_available|boolean|false|Is domain available. If not then it is already reserved by someone else.
» time_reserved|string(date-time)|false|Date and time when domain was reserved
